Feature: Register Functionality
  ...
  Scenario Outline: Register with valid data
    ...
    When user fill registration form with
      | username   | password   | confirmPassword   | firstName   | lastName   | email   | phone   | address   | age   |
      | <username> | <password> | <confirmPassword> | <firstName> | <lastName> | <email> | <phone> | <address> | <age> |
    And click on register button
    Then user is redirected to "http://192.168.10.158/BeerShop/login.php#" url
    Examples:
      | username | password        | confirmPassword | firstName | lastName | email       | phone | address                             | age |
      | [8a]     | ola123A!        | ola123A!        | Ivan      | Stoev    | [9a]@abv.bg | [10]  | Sofia, j.k.Ivan Vazov, ul.Balsha N6 | 18  |
      | [8a]     | parola123A!     | parola123A!     | Ivan      | Stoev    | [9a]@abv.bg | [10]  | Sofia, j.k.Ivan Vazov, ul.Balsha N1 | 18  |
      | [4a]     | parola123A!     | parola123A!     | Ivan      | Stoev    | [9a]@abv.bg | [10]  | Sofia, j.k.Ivan Vazov, ul.Balsha N3 | 99  |
      | [8a]     | parola123A!paro | parola123A!paro | Ivan      | Stoev    | [9a]@abv.bg | [10]  | Sofia, j.k.Ivan Vazov, ul.Balsha N6 | 18  |
  ...
  Scenario Outline: Register with invalid data with checked checkboxes
    ...
    When user fill registration form with
      ...
      | <username> | <password> | <confirmPassword> | <firstName> | <lastName> | <email> | <phone> | <address> | <age> |
    And click on register button
    Then user is redirected to "http://192.168.10.158/BeerShop/register.php" url
    Examples:
      | username | password    | confirmPassword | firstName | lastName | email                | phone      | address                             | age |
  ...
  Scenario Outline: Check frontend validation messages on Register with invalid data
    ...
    Examples:
      | username | password    | confirmPassword | firstName | lastName | email                | phone      | address                             | age | Error messages                      |
